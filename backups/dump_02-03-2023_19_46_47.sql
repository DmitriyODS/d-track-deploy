...
CREATE TABLE user_data.level_accesses (
    id integer NOT NULL,
    name text DEFAULT ''::text NOT NULL,
    access bit(8) DEFAULT '0'::"bit" NOT NULL
);
...
1	admin	admin	$1$8g4juYqD$c3gAZA9mKtUGqwmQoXa6V1				3	1	0	2023-03-02 16:32:49.275877	1970-01-01 00:00:00
\.
...
0	Не задано	00000000
1	Администратор	11111111
2	Мастер	00011011
3	Менеджер	00111111
4	Документалист	11000011
5	Руководитель	11111111
\.
...
SELECT pg_catalog.setval('user_data.employees_id_seq', 1, false);
